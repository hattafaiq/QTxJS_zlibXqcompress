...
private:
    ...
    void masuk_tipe_data_server(QSqlQuery *query);
    QVector<int> info_data[3];
    ...
    QStringList info_name_aset_server;
    ...
    QString data_list_sementara;
    //--------------------------//
//    void masukkan_aset();
//    void masukkan_aset_server();
